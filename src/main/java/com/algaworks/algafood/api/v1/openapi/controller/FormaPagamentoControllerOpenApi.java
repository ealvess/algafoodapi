...
public interface FormaPagamentoControllerOpenApi {
	...
	/* 
	   response = "FormasPagamentoModelOpenApi.class" não funciona, e continua retornando um exemplo vazio na documentação
	   Mesmo usando o swagger v3, note que as anotações @ApiOperation , @ApiResponses e @ApiResponse possuem duas versões 
	   que podem ser usadas , a da v2 e a da v3. Para solucionar esse caso, usei anotações da v2.
